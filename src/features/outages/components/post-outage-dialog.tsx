...
export function PostOutageDialog({
  open,
  onOpenChange,
  onSubmit,
  officeId,
      ...
      <DialogContent className="bg-card border-border max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {AVAILABLE_ZONES.filter((z) => !selectedZones.includes(z)).map(
                (zone) => (
                  <Badge
                    key={zone}
                    variant="outline"
          ...
          <div className="p-4 bg-secondary rounded-lg border border-border">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Based on {selectedZones.length} selected zone
                {selectedZones.length !== 1 ? "s" : ""} in your office area
              </p>
            </div>
          </div>
        </div>
        <DialogFooter>
          ...
          <Button
            ...
            disabled={
              !title || !message || selectedZones.length === 0 || loading
            }
