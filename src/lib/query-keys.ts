...
export const queryKeys = {
  ...
  tickets: {
    ...
    detail: (id: string | number) => [...queryKeys.tickets.details(), id] as const,
  },
  ...
  outages: {
    ...
    list: (filters: Record<string, unknown>) => [...queryKeys.outages.lists(), { filters }] as const,
    details: () => [...queryKeys.outages.all, 'detail'] as const,
    detail: (id: string | number) => [...queryKeys.outages.details(), id] as const,
  },
  ...
  refunds: {
    ...
    detail: (id: string | number) => [...queryKeys.refunds.details(), id] as const,
    user: (userId: string | number) => [...queryKeys.refunds.all, 'user', userId] as const,
  },
  ...
  dashboard: {
    ...
    technicianStats: () => [...queryKeys.dashboard.stats(), 'technician'] as const,
    supervisorStats: () => [...queryKeys.dashboard.stats(), 'supervisor'] as const,
